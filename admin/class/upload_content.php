...
class upload{
	...
	public function upload_content(){
		...
		if(isset($_POST["submit"])) {
			...
			$sql="";
			$sql = "INSERT INTO contents (category,subcategory,content_id,name,preview_link,file_link, uploded_by,downloaded,status,remarks,portal)
					VALUES ('$category','$subcategory','$filename','$name','$target_link_preview', '$target_link', 'Murad','0','published','$remarks','$portal_name')";				
