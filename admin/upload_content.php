				...
				<div class="widget-body form">
					<form action="" method="POST" enctype="multipart/form-data" class="form-horizontal"> 
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span6 " name="portal" placeholder="Portal name" required="" tabindex="3">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">Remarks *</label>
							<div class="controls">
								<input type="text" class="span6 " name="remarks" placeholder="Remarks" required="" tabindex="3">
							</div>
						</div>
						<div class="controls">
